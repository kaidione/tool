...
__all__ = [
    ...
    'ZoomUnit_SmallDecrement', 'StyleId_Heading3',
    'NavigateDirection_Parent', 'ZoomUnit_LargeDecrement',
    'UIA_GridItemColumnPropertyId', 'UIA_ThumbControlTypeId',
    'HeadingLevel_None', 'IUIAutomationNotCondition',
    'UIA_LiveRegionChangedEventId', 'UIA_GridItemPatternId',
    'UIA_PaneControlTypeId', 'StyleId_Title',
    'UIA_NativeWindowHandlePropertyId', 'TreeScope_Children',
    'UIA_CenterPointPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_NotificationEventId', 'UIA_Window_WindowOpenedEventId',
    'UIA_DragIsGrabbedPropertyId', 'NotificationKind_ItemRemoved',
    ...
    'AnnotationType_FormatChange', 'UIA_SynchronizedInputPatternId',
    'RowOrColumnMajor_Indeterminate',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'IUIAutomationInvokePattern', 'UIA_IsKeyboardFocusablePropertyId',
    'IUIAutomation2', 'StructureChangeType_ChildrenReordered',
    'UIA_FlowsToPropertyId', 'UIA_StyleNameAttributeId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_DescribedByPropertyId', 'CUIAutomation8',
    ...
    'UIA_LegacyIAccessibleRolePropertyId', 'Off',
    'UIA_CalendarControlTypeId', 'UIA_ProgressBarControlTypeId',
    'UIA_RangeValueIsReadOnlyPropertyId', 'TextUnit_Format',
    'UIA_TableItemPatternId', 'AnnotationType_GrammarError',
    'AnnotationType_TrackChanges', 'IUIAutomationMultipleViewPattern',
    'StructureChangeType_ChildrenInvalidated',
    'IUIAutomationElement5', 'UIA_TextPatternId',
    'UIA_Invoke_InvokedEventId',
    'UIA_ScrollHorizontalScrollPercentPropertyId', 'HeadingLevel5',
    'UIA_AutomationIdPropertyId', 'UIA_CustomNavigationPatternId',
    'TextPatternRangeEndpoint_End',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_DropTarget_DragLeaveEventId', 'UIA_ScrollItemPatternId',
    'ToggleState_Off', 'UIA_MenuItemControlTypeId',
    ...
    'UIA_OutlineStylesAttributeId', 'UIA_AriaRolePropertyId',
    'ScrollAmount', 'DockPosition_Bottom',
    'UIA_SelectionActiveEndAttributeId', 'IUIAutomation4',
    'StructureChangeType_ChildrenBulkAdded', 'UiaChangeInfo',
    'TextUnit_Document', 'AnnotationType_MoveChange',
    'ScrollAmount_SmallDecrement', 'UIA_MenuBarControlTypeId',
    'AnnotationType_ConflictingChange',
    'IUIAutomationScrollItemPattern',
    'UIA_SelectionSelectionPropertyId', 'UIA_DataGridControlTypeId',
    'UIA_ForegroundColorAttributeId',
    'UIA_GridItemColumnSpanPropertyId', 'IUIAutomationDragPattern',
    'StyleId_BulletedList', 'ExpandCollapseState',
    'UIA_RangeValueLargeChangePropertyId', 'IUIAutomation',
    'UIA_SizePropertyId', 'UIA_CapStyleAttributeId',
    'ProviderOptions_RefuseNonClientSupport', 'UIA_GridPatternId',
    ...
    'UIA_RangeValueMinimumPropertyId', 'UIA_CheckBoxControlTypeId',
    'UIA_TransformPatternId', 'UIA_OrientationPropertyId',
    'UIA_SemanticZoomControlTypeId', 'StructureChangeType',
    'ExpandCollapseState_LeafNode', 'UIA_SelectionPatternId',
    'UIA_NamePropertyId', 'UIA_RangeValueSmallChangePropertyId',
    'DockPosition', 'ProviderOptions_HasNativeIAccessible',
    ...
    'UIA_SeparatorControlTypeId', 'AnnotationType_Footer', 'TextUnit',
    'TextUnit_Line', 'UIA_TitleBarControlTypeId',
    'AnnotationType_SpellingError', 'StyleId_Emphasis',
    'StyleId_Subtitle', 'UIA_IsPasswordPropertyId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_MarginBottomAttributeId', 'UIA_ToolTipOpenedEventId',
    'IUIAutomationElement4', 'ToggleState', 'UIA_RangeValuePatternId',
    'UIA_ItemTypePropertyId', 'UIA_SelectionItemPatternId',
    'StyleId_Custom', 'IUIAutomationItemContainerPattern',
    'UIA_NavigationLandmarkTypeId', 'UIA_InvokePatternId',
    'UIA_OutlineColorPropertyId', 'TextEditChangeType_AutoComplete',
    'UIA_IsReadOnlyAttributeId', 'UIA_LayoutInvalidatedEventId',
    'UIA_UnderlineColorAttributeId', 'UIA_OutlineThicknessPropertyId',
    'UIA_ToolBarControlTypeId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_Selection_InvalidatedEventId', 'UIA_ListControlTypeId',
    'UIA_IsRequiredForFormPropertyId',
    'PropertyConditionFlags_IgnoreCase', 'IUIAutomationTextRange3',
    'UIA_StylesStyleNamePropertyId',
    'AnnotationType_CircularReferenceError',
    'TextEditChangeType_Composition', 'UIA_WindowIsTopmostPropertyId',
    'WindowVisualState_Minimized', 'CUIAutomation',
    'UIA_WindowControlTypeId', 'SupportedTextSelection',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_LandmarkTypePropertyId', 'UIA_TextEditPatternId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'WindowInteractionState_Running', 'UIA_AcceleratorKeyPropertyId',
    ...
    'UIA_WindowIsModalPropertyId', 'DockPosition_Left',
    'HeadingLevel2', 'AnnotationType_Mathematics',
    'IUIAutomationElement8', 'UIA_ScrollBarControlTypeId',
    'UIA_MultipleViewPatternId', 'SynchronizedInputType_KeyDown',
    'IUIAutomation6', 'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_AnnotationObjectsPropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_FormLandmarkTypeId', 'AnnotationType_DataValidationError',
    'UIA_TransformPattern2Id', 'SynchronizedInputType_LeftMouseDown',
    'StyleId_Heading7', 'IUIAutomationSynchronizedInputPattern',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'IUIAutomationAndCondition', 'UIA_DragDropEffectsPropertyId',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_SplitButtonControlTypeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_OverlineStyleAttributeId',
    'UIA_IsTextPatternAvailablePropertyId', 'UIA_IsEnabledPropertyId',
    ...
    'SupportedTextSelection_None', 'IUIAutomationCondition',
    'ProviderOptions_UseClientCoordinates',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_CustomLandmarkTypeId', 'UIA_AutomationFocusChangedEventId',
    'HeadingLevel3', 'AnnotationType_Comment',
    'UIA_LegacyIAccessibleStatePropertyId',
    'IUIAutomationDropTargetPattern',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_TransformCanResizePropertyId', 'UIA_AnnotationPatternId',
    'UIA_AnnotationObjectsAttributeId', 'StyleId_Heading9',
    'UIA_HeaderControlTypeId', 'UIA_Drag_DragStartEventId',
    'IAccessible', 'OrientationType',
    'UIA_ProviderDescriptionPropertyId',
    'UIA_Text_TextChangedEventId', 'UIA_ObjectModelPatternId',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_InputDiscardedEventId', 'UIA_SizeOfSetPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_DockDockPositionPropertyId', 'TextEditChangeType_None',
    'UIA_SayAsInterpretAsMetadataId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'IUIAutomationBoolCondition', 'UIA_AnnotationDateTimePropertyId',
    'UIA_AriaPropertiesPropertyId', 'ScrollAmount_NoAmount',
    'UIA_HelpTextPropertyId', 'UIA_RuntimeIdPropertyId',
    'UIA_ItemStatusPropertyId', 'IUIAutomationElement7',
    'UIA_VisualEffectsPropertyId', 'UIA_LinkAttributeId',
    'AnnotationType_Footnote', 'ProviderOptions_UseComThreading',
    'UIA_AutomationPropertyChangedEventId', 'AnnotationType_Author',
    'IUIAutomationTextEditPattern', 'TextPatternRangeEndpoint',
    'SynchronizedInputType_LeftMouseUp', 'UIA_DataItemControlTypeId',
    'UIA_StylesFillPatternColorPropertyId',
    'NavigateDirection_LastChild', 'UIA_ControlTypePropertyId',
    'WindowVisualState', 'IUIAutomationTransformPattern2',
    'UIA_StylesStyleIdPropertyId', 'UIA_CaretBidiModeAttributeId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'ZoomUnit_SmallIncrement', 'UIA_LocalizedControlTypePropertyId',
    'UIA_ImageControlTypeId', 'SynchronizedInputType_RightMouseUp',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'TreeScope_None', 'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_PositionInSetPropertyId', 'UIA_AppBarControlTypeId',
    'IUIAutomationTableItemPattern', 'IUIAutomationDockPattern',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_ComboBoxControlTypeId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_ValueIsReadOnlyPropertyId', 'CoalesceEventsOptions',
    'IUIAutomationSpreadsheetPattern', 'UIA_GroupControlTypeId',
    'UIA_SelectionIsSelectionRequiredPropertyId', 'IUIAutomation5',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_StylesShapePropertyId', 'OrientationType_Horizontal',
    'UIA_InputReachedOtherElementEventId', 'TreeScope_Element',
    'UIA_IsPeripheralPropertyId', 'UIA_ChangesEventId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_CustomControlTypeId', 'IUIAutomationAnnotationPattern',
    'LiveSetting', 'UIA_TogglePatternId',
    'UIA_ToggleToggleStatePropertyId', 'UIA_IsActiveAttributeId',
    'TreeTraversalOptions_LastToFirstOrder', 'StyleId_Heading5',
    'UIA_IndentationTrailingAttributeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'ExpandCollapseState_Collapsed', 'UIA_AnnotationTypesPropertyId',
    ...
    'UIA_InputReachedTargetEventId', 'NavigateDirection_NextSibling',
    'UIA_LegacyIAccessiblePatternId', 'PropertyConditionFlags',
    'UIA_AnnotationAnnotationTypeIdPropertyId', 'DockPosition_Top',
    'UIA_HyperlinkControlTypeId', 'NotificationKind',
    'OrientationType_Vertical', 'ScrollAmount_LargeIncrement',
    'StyleId_Heading1', 'ProviderOptions_ProviderOwnsSetFocus',
    'NotificationProcessing_All', 'NavigateDirection_PreviousSibling',
    'UIA_BackgroundColorAttributeId',
    'UIA_IsContentElementPropertyId', 'IUIAutomationEventHandler',
    'AutomationElementMode', 'HeadingLevel8',
    'UIA_SelectionPattern2Id', 'StructureChangeType_ChildAdded',
    'UIA_StylesFillColorPropertyId', 'UIA_MarginTopAttributeId',
    'UIA_SpreadsheetItemPatternId', 'UIA_GridItemRowPropertyId',
    'UIA_GridItemContainingGridPropertyId', 'UIA_TextControlTypeId',
    'IUIAutomationVirtualizedItemPattern',
    'IUIAutomationNotificationEventHandler', 'IUIAutomationElement6',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_LabeledByPropertyId', 'UIA_AnnotationAuthorPropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_RotationPropertyId', 'ToggleState_Indeterminate',
    'WindowVisualState_Normal', 'StyleId_Heading4',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_IsSubscriptAttributeId', 'IUIAutomationElement9',
    ...
    'CoalesceEventsOptions_Disabled', 'UIA_TabsAttributeId',
    ...
    'PropertyConditionFlags_None', 'IUIAutomationChangesEventHandler',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'AnnotationType_FormulaError', 'ToggleState_On',
    'StyleId_NumberedList', 'WindowInteractionState_Closing',
    'StructureChangeType_ChildRemoved', 'DockPosition_None',
    'UIA_Window_WindowClosedEventId', 'UIA_TableRowHeadersPropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'UIA_AsyncContentLoadedEventId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_FillColorPropertyId', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationElement', 'IUIAutomationTextPattern',
    'NotificationProcessing_MostRecent', 'DockPosition_Right',
    'UIA_IndentationLeadingAttributeId', 'UIA_ToolTipControlTypeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId', 'StyleId_Heading8',
    'TextEditChangeType_CompositionFinalized',
    'WindowVisualState_Maximized', 'UIA_ItemContainerPatternId',
    'Assertive', 'TextUnit_Paragraph',
    'SynchronizedInputType_RightMouseDown', 'StyleId_Heading6',
    'IUIAutomation3', 'TextPatternRangeEndpoint_Start',
    'UIA_EditControlTypeId', 'UIA_SystemAlertEventId',
    'IUIAutomationRangeValuePattern',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_IsOffscreenPropertyId', 'UIA_WindowPatternId',
    ...
    'StyleId_Heading2', 'UIA_IsValuePatternAvailablePropertyId',
    'IUIAutomationStylesPattern', 'UIA_GridColumnCountPropertyId',
    'UIA_Selection2ItemCountPropertyId', 'TextUnit_Word',
    'UIA_DropTarget_DroppedEventId', 'IUIAutomationProxyFactoryEntry',
    'AnnotationType_Highlighted', 'IUIAutomationGridItemPattern',
    'UIA_LegacyIAccessibleNamePropertyId', 'UIA_MenuControlTypeId',
    ...
    'AnnotationType_EditingLockedChange', 'TreeScope_Parent',
    'UIA_IsItalicAttributeId', 'UIA_IsSuperscriptAttributeId',
    'ProviderOptions_OverrideProvider', 'UIA_StyleIdAttributeId',
    'UIA_ClassNamePropertyId', 'IUIAutomationTablePattern',
    'UIA_ControllerForPropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'IUIAutomationGridPattern', 'HeadingLevel1',
    'UIA_MarginTrailingAttributeId',
    'UIA_Transform2CanZoomPropertyId', 'IUIAutomationCacheRequest',
    'NotificationProcessing_ImportantMostRecent', 'TextUnit_Page',
    'IUIAutomationWindowPattern', 'UIA_DropTarget_DragEnterEventId',
    'TreeScope', 'TreeTraversalOptions', 'TreeScope_Subtree',
    ...
    'SynchronizedInputType', 'OrientationType_None',
    'UIA_ScrollHorizontallyScrollablePropertyId', 'StyleId_Quote',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_BeforeParagraphSpacingAttributeId',
    'TextEditChangeType_AutoCorrect',
    'UIA_LegacyIAccessibleValuePropertyId', 'TreeScope_Descendants',
    'ExpandCollapseState_Expanded', 'Polite',
    'NotificationProcessing_ImportantAll', 'UIA_LevelPropertyId',
    'UIA_FontNameAttributeId', 'IUIAutomationPropertyCondition',
    'RowOrColumnMajor', 'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_AnnotationTargetPropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_FillTypePropertyId', 'UIA_MenuClosedEventId',
    'UIA_MenuModeEndEventId', 'AnnotationType_Unknown',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_MenuModeStartEventId', 'UIA_IsDataValidForFormPropertyId',
    'TextEditChangeType', 'UIA_SpinnerControlTypeId',
    'IUIAutomationTreeWalker', 'UIA_WindowCanMaximizePropertyId',
    'UIA_ProcessIdPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_GridItemRowSpanPropertyId', 'UIA_Drag_DragCompleteEventId',
    'IUIAutomationElement3', 'IUIAutomationProxyFactoryMapping',
    'NotificationKind_ItemAdded', 'UIA_TextEdit_TextChangedEventId',
    'UIA_SliderControlTypeId', 'IUIAutomationValuePattern',
    'UIA_FontWeightAttributeId', 'IUIAutomationOrCondition',
    'UIA_AnimationStyleAttributeId', 'DockPosition_Fill',
    'ScrollAmount_LargeDecrement', 'NavigateDirection',
    'UIA_StylesPatternId', 'IUIAutomationSelectionPattern2',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_ListItemControlTypeId', 'UIA_MainLandmarkTypeId',
    'UIA_ValuePatternId', 'HeadingLevel9',
    'UIA_FullDescriptionPropertyId', 'UIA_TextPattern2Id',
    'HeadingLevel7', 'UIA_OverlineColorAttributeId',
    'UIA_AccessKeyPropertyId', 'RowOrColumnMajor_RowMajor',
    'UIA_BulletStyleAttributeId', 'IUIAutomationScrollPattern',
    'UIA_StructureChangedEventId',
    'UIA_Text_TextSelectionChangedEventId', 'TextUnit_Character',
    'UIA_MenuOpenedEventId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_UnderlineStyleAttributeId', 'IUIAutomationTextRangeArray',
    'NotificationKind_ActionCompleted', 'IUIAutomationElementArray',
    'UIA_IsHiddenAttributeId', 'UIA_TransformCanRotatePropertyId',
    'UIA_FontSizeAttributeId', 'UIA_ValueValuePropertyId',
    'NotificationKind_ActionAborted', 'UIA_TablePatternId',
    'UIA_ScrollPatternId', 'NotificationProcessing', 'ZoomUnit',
    'UIA_MarginLeadingAttributeId',
    'UIA_StrikethroughStyleAttributeId', 'AnnotationType_Header',
    'AnnotationType_DeletionChange',
    'UIA_StrikethroughColorAttributeId', 'UIA_TabControlTypeId',
    'UIA_AnnotationTypesAttributeId', 'ZoomUnit_LargeIncrement',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_SearchLandmarkTypeId', 'UIA_ToolTipClosedEventId',
    ...
    'IUIAutomationEventHandlerGroup', 'ProviderOptions',
    'RowOrColumnMajor_ColumnMajor', 'HeadingLevel4',
    'UIA_BoundingRectanglePropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_DockPatternId', 'ProviderOptions_ClientSideProvider',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_RangeValueValuePropertyId', 'UIA_ButtonControlTypeId',
    'UIA_IsTogglePatternAvailablePropertyId', 'HeadingLevel6',
    'UIA_DragGrabbedItemsPropertyId',
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_IsDialogPropertyId',
    'UIA_TextFlowDirectionsAttributeId', 'IUIAutomationTogglePattern',
    'TreeScope_Ancestors', 'UIA_Drag_DragCancelEventId',
    'UIA_StatusBarControlTypeId', 'UIA_HeaderItemControlTypeId',
    'AnnotationType_UnsyncedChange', 'UIA_TableControlTypeId',
    'AutomationElementMode_None',
    'UIA_IsTextPattern2AvailablePropertyId'
]

_check_version('1.1.14', 1655520004.800894)
